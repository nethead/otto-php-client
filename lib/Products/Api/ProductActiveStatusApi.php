...
class ProductActiveStatusApi
{
     ...
     * @return \Otto\Client\Products\Model\ActiveStatusListResponse
     */
     ...
     * @throws \Otto\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Otto\Client\Products\Model\ActiveStatusListResponse, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    {
        $returnType = '\Otto\Client\Products\Model\ActiveStatusListResponse';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Otto\Client\Products\Model\ActiveStatusListResponse',

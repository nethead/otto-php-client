...
class BrandsApi
{
     ...
     * @return \Otto\Client\Products\Model\Brand[]
     */
     ...
     * @throws \Otto\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Otto\Client\Products\Model\Brand[], HTTP status code, HTTP response headers (array of strings)
     */
    public function getBrandsWithHttpInfo()
    {
        $returnType = '\Otto\Client\Products\Model\Brand[]';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Otto\Client\Products\Model\Brand[]',

...
class ReturnsV2Api
{
     ...
     * @return \Otto\Client\Model\PositionItemListReturnsV2
     */
     ...
     * @throws \Otto\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Otto\Client\Model\PositionItemListReturnsV2, HTTP status code, HTTP response headers (array of strings)
     */
    public function returnsV2GetPositionItemsForUsingGETV2WithHttpInfo($limit = '10', $page = '1', $status = null)
    {
        $returnType = '\Otto\Client\Model\PositionItemListReturnsV2';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Otto\Client\Model\PositionItemListReturnsV2',
                ...
                case 400:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Otto\Client\Model\ApiErrorResponseReturnsV2',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  \Otto\Client\Model\AcceptedPartnerReturnV2ReturnsV2 $body acceptedPartnerReturn (required)
     *
     * @throws \Otto\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return object
        ...
        try {
            ...
            switch ($e->getCode()) {
                ...
                case 207:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Otto\Client\Model\AcceptedReturnMultiStatusResponseReturnsV2',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  \Otto\Client\Model\RejectedPartnerReturnV2ReturnsV2 $body rejectedPartnerReturn (required)
     *
     * @throws \Otto\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return object
        ...
        try {
            ...
            switch ($e->getCode()) {
                ...
                case 207:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Otto\Client\Model\RejectedReturnMultiStatusResponseReturnsV2',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;

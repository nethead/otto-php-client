...
class ShipmentsV1Api
{
     ...
     *
     * @param  \Otto\Client\Model\PositionItemShipmentsV1[] $body The position items included in shipment. (required)
     ...
     *
     * @param  \Otto\Client\Model\PositionItemShipmentsV1[] $body positionItems (required)
     ...
     *
     * @param  \Otto\Client\Model\CreateShipmentRequestShipmentsV1 $body request (required)
     *
     * @throws \Otto\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Otto\Client\Model\CreateShipmentResponseShipmentsV1
     */
     ...
     * @throws \Otto\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Otto\Client\Model\CreateShipmentResponseShipmentsV1, HTTP status code, HTTP response headers (array of strings)
     */
        ...
        try {
            ...
            switch ($e->getCode()) {
                ...
                case 401:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Otto\Client\Model\UnauthenticatedShipmentsV1',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \Otto\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Otto\Client\Model\ShipmentListShipmentsV1
     */
     ...
     * @throws \Otto\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Otto\Client\Model\ShipmentListShipmentsV1, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     * @throws \Otto\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Otto\Client\Model\ShipmentShipmentsV1
     */
     ...
     * @throws \Otto\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Otto\Client\Model\ShipmentShipmentsV1, HTTP status code, HTTP response headers (array of strings)
     */

...
class PaymentOrdersV4 implements ModelInterface, ArrayAccess
{
     ...
     * Sets payment_method
     *
     * @param string $payment_method The payment method. Values currently in use are \"INVOICE_SINGLE\", \"INVOICE_INSTALLMENTS\", \"PREPAYMENT\", \"DIRECT_DEBIT\", \"DIRECT_DEBIT_INSTALLMENTS\", \"CREDIT_CARD_ONLINE\". These values are subject to change.
     *
     * @return $this
     */

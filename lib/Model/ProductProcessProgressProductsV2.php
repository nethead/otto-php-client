...
'total' => 'int',
'ping_after' => '\DateTime',
'links' => '\Otto\Client\Model\ProductProcessResultLinkProductsV2[]'    ];
...
self::STATE_FAILED,        ];
     ...
     * Gets links
     *
     * @return \Otto\Client\Model\ProductProcessResultLinkProductsV2[]
     */
     ...
     * Sets links
     *
     * @param \Otto\Client\Model\ProductProcessResultLinkProductsV2[] $links a list of links that can be used to access detailed information about the process result
     *
     * @return $this
     */

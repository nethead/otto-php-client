 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CategoryGroupsProductsV2 implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CategoryGroups__Products-V2';
...
'links' => 'getLinks'    ];
     ...
     *
     * @return \Otto\Client\Model\CategoryGroupProductsV2[]
     */
     ...
     *
     * @param \Otto\Client\Model\CategoryGroupProductsV2[] $category_groups a list of the category groups defined on the OTTO market place.
     *
     * @return $this
     */
     ...
     * Sets links
     *
     * @param \Otto\Client\Model\LinkProductsV2[] $links a list of links that can be used for pagination (among others).
     *
     * @return $this
     */

...
class LineItemsReceiptsV3 implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'item_positions' => '\Otto\Client\Model\ItemPositionsReceiptsV3[]',
'item_partial_refund_positions' => '\Otto\Client\Model\ItemPartialRefundPositionsReceiptsV3[]',
'service_positions' => '\Otto\Client\Model\ServicePositionReceiptsV3[]',
'delivery_costs' => '\Otto\Client\Model\DeliveryCostsReceiptsV3[]'    ];
...
'delivery_costs' => 'getDeliveryCosts'    ];
     ...
     * Gets item_positions
     *
     * @return \Otto\Client\Model\ItemPositionsReceiptsV3[]
     */
     ...
     * Sets item_positions
     *
     * @param \Otto\Client\Model\ItemPositionsReceiptsV3[] $item_positions List of billed items, if exists.  This list is only used in context of receiptType PURCHASE or REFUND. If there are no entries the lists is displayed as empty
     *
     * @return $this
     */
     ...
     *
     * @return \Otto\Client\Model\ItemPartialRefundPositionsReceiptsV3[]
     */
     ...
     *
     * @param \Otto\Client\Model\ItemPartialRefundPositionsReceiptsV3[] $item_partial_refund_positions List of billed partial refunds of items.  This list is only used in context of receiptType PARTIAL_REFUND. If there are no entries the lists is displayed as empty
     *
     * @return $this
     */
     ...
     *
     * @param \Otto\Client\Model\ServicePositionReceiptsV3[] $service_positions List of billed B2C services, if exists for this receipt.  This list is only used in context of receiptType PURCHASE or REFUND. If there are no entries the lists is displayed as empty
     *
     * @return $this
     */
     ...
     * Gets delivery_costs
     *
     * @return \Otto\Client\Model\DeliveryCostsReceiptsV3[]
     */
     ...
     * Sets delivery_costs
     *
     * @param \Otto\Client\Model\DeliveryCostsReceiptsV3[] $delivery_costs List of billed logistic costs, if exists for this receipt.  This list is only used in context of receiptType PURCHASE or REFUND. If there are no entries the lists is displayed as empty
     *
     * @return $this
     */

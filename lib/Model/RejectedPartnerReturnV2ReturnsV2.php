...
/**
 * RejectedPartnerReturnV2ReturnsV2 Class Doc Comment
 *
 * @category Class
 * @package  Otto\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class RejectedPartnerReturnV2ReturnsV2 implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'RejectedPartnerReturnV2__Returns-V2';
    ...
    protected static $swaggerTypes = [
        'position_items' => '\Otto\Client\Model\RejectedPositionItemReturnsV2[]'    ];
     ...
     * Sets position_items
     *
     * @param \Otto\Client\Model\RejectedPositionItemReturnsV2[] $position_items List of all the items received from partner
     *
     * @return $this
     */

...
/**
 * AcceptedReturnMultiStatusResponseReturnsV2 Class Doc Comment
 *
 * @category Class
 * @package  Otto\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class AcceptedReturnMultiStatusResponseReturnsV2 implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'AcceptedReturnMultiStatusResponse__Returns-V2';
    ...
    protected static $swaggerTypes = [
        'results' => '\Otto\Client\Model\ReturnedPositionItemReturnsV2[]',
'errors' => '\Otto\Client\Model\ApiErrorReturnsV2[]'    ];
...
'errors' => 'getErrors'    ];
     ...
     * Gets results
     *
     * @return \Otto\Client\Model\ReturnedPositionItemReturnsV2[]
     */
     ...
     * Sets results
     *
     * @param \Otto\Client\Model\ReturnedPositionItemReturnsV2[] $results List of all the items received from partner
     *
     * @return $this
     */
     ...
     * Gets errors
     *
     * @return \Otto\Client\Model\ApiErrorReturnsV2[]
     */
     ...
     * Sets errors
     *
     * @param \Otto\Client\Model\ApiErrorReturnsV2[] $errors errors
     *
     * @return $this
     */

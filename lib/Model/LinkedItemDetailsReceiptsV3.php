...
'service_relations' => '\Otto\Client\Model\ServiceRelationsReceiptsV3[]'    ];
...
'service_relations' => 'getServiceRelations'    ];
     ...
     *
     * @return \Otto\Client\Model\ServiceRelationsReceiptsV3[]
     */
     ...
     *
     * @param \Otto\Client\Model\ServiceRelationsReceiptsV3[] $service_relations List of ServiceRelation objects.  Contains entries if services were sold  together with items otherwise list is empty
     *
     * @return $this
     */

...
'attributes' => '\Otto\Client\Model\AttributeProductsV2[]'    ];
...
'attributes' => 'getAttributes'    ];
     ...
     * Gets attributes
     *
     * @return \Otto\Client\Model\AttributeProductsV2[]
     */
     ...
     * Sets attributes
     *
     * @param \Otto\Client\Model\AttributeProductsV2[] $attributes Lists all the descriptive information about a product variant a partner can provide. Must be provided in the form of a key values pair. Will be validated against the AttributeDefinitions from Category endpoint provided by Otto market.
     *
     * @return $this
     */

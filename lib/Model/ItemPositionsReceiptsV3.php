...
'price_modifications' => 'getPriceModifications'    ];
     ...
     *
     * @param \Otto\Client\Model\PriceModificationReceiptsV3[] $price_modifications List of additional fees and reductions represented as price modifications.  Currently we only know reductions. If there are no entries the lists is displayed as empty
     *
     * @return $this
     */

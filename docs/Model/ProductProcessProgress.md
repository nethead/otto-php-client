...
**ping_after** | **int** | recommendation when to poll this resource again to receive a meaningful update | [optional] 
**links** | [**\Otto\Client\Products\Model\ProductProcessResultLink[]**](ProductProcessResultLink.md) | a list of links that can be used to access detailed information about the process result | [optional] 
